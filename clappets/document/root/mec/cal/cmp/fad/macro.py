...
from techclappets.mechanical.compressor.comp_api617 import Hpolytropic, absPower, Tdischarge, Qactual, polyeff, nexp, centframe, theta, HpmaxWheel
from techclappets.thermochem.thermochem_utils import mixture_props
from math import *
from techclappets.mechanical.compressor.air import moistAirDensity, humidityRatio
