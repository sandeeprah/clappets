...
from techclappets.mechanical.cfgpump.pump import motor_syncspeed, specific_speed, efficiency_overall, head_coefficient, nozzle_size, getNPSHR, model_select, pump_power, pump_dimensions, DN2NPS
